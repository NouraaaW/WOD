...
This system was developed as part of our Web Applications Engineering course (IT312) at King Saud University, College of Computer and Information Sciences (CCIS).
...
Application Layer (Logic) — PHP for authentication and backend logic.
Data Layer (Database) — MySQL to store user, post, wishlist, and event data.
🗂️ Main Pages
Page	Description
